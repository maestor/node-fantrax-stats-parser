...
- Evaluate whether any remaining career/leaderboard `services.test.ts` happy paths should move to DB-backed route integration, while keeping direct unit coverage for the aggregation-heavy transforms
