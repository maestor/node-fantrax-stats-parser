...
- Continue pruning the remaining mock-heavy `services.test.ts` happy-path coverage where DB-backed route integration already exercises the same behavior end-to-end
